<div class="wp_vimeo_container">
    <div class="wp_vimeo_content">
        <div class="wp_vimeo_header">
            ...
            <div class="wp_vimeo_row">
                <div class="wp_vimeo_search wp_vimewo_fieldwrap">
            ...
            <div class="wp_vimeo_row">
                <div class="wp_vimeo_sort wp_vimeo_col_3 wp_vimewo_fieldwrap">
                ...
                <div id="" class="wp_vimeo_filter wp_vimeo_col_3 wp_vimewo_fieldwrap">
				...
				<div id="" class="wp_vimeo_filter wp_vimeo_col_3 wp_vimewo_fieldwrap">					<label><?php _e('Filter By Tag', 'wp-vimeo'); ?></label>
