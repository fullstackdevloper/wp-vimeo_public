...
class WpVimeoActions {
    ...
    public function uploadVideo() {
        ...
        if (array_key_exists('wp_vimeo_video', $postData)) {
            ...
            $milstone_option = $postData['wp_vimeo_video']['milstone_option'];
			
			$milstone_sting = implode(",",$milstone_option);
            ...
            if ($uri) {
				...
				if(isset($vimeo_folder_id[0])){	
					...
					foreach($milstone_option as $milstone_op){
						$video_tag[] = ['name'=>ucwords($milstone_op)];
					}
                ...
                if ($videoLink) {
                    ...
                    $array = [
                        ...
                        'meta_input' => [
                            ...
                            'milstone_option' => $milstone_sting,
                        ]
                    ];
