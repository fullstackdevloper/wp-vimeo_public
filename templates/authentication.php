<div class="wp_vimeo_authentication_wrap">
    <div class="wp_vimeo_row">
        <div class="wp_vimeo_register_wrap wp_vimeo_col_6">
            <h2 class="wp_vimeo_register_text"><?php print apply_filters('wp-vimeo-register-text', __("Register Account", 'wp_vimeo')); ?></h2>
        ...
        <div class="wp_vimeo_login_wrap wp_vimeo_col_6">
